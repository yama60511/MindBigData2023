...
def main():
    ...
    eeg_cols = get_eeg_cols(pd.read_csv(csv_paths[0], nrows=0).columns.tolist())
    ...
    for i, temp_file in enumerate(temp_files, 1):
        ...
        np.savez_compressed(out_path, meta=meta.to_records(index=False), images=images, eeg=eeg)
        temp_file.unlink()
